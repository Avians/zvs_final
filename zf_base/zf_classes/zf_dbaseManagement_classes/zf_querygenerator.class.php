...
class Zf_QueryGenerator
{
      ...
      /**
       * This is property that is used to instantiate the Form Controller library for 
       * validating and reporting various form errors.
       * 
       * @var type protected
       */
        protected $zf_formController;
	...
	public function __construct($connect = true, $database = null, $server = null,
                ...
                /**
                 * Here we instantiate the form controller class so that if there is any form
                 * being processed in a given model, the it can be validated and then if there
                 * occurs any errors, they can be reported necessarily.
                 */
                $this->zf_formController = new Zf_FormController();
