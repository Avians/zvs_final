...
class studentProfile_Model extends Zf_Model {
    ...
    private function actualStudentProfileData($systemSchoolCode, $studentAdmissionNumber){
        ...
        if($studentDetails == 0){
            ...
            foreach ($studentDetails as $studentValues) {
                ...
                $studentGender = empty($studentValues['studentGender']) ? "Not set" : $studentValues['studentGender']; 
                $studentDateOfBirth = empty($studentValues['studentDateOfBirth']) ? "Not set" : $studentValues['studentDateOfBirth']; $studentReligion = $studentValues['studentReligion'];
