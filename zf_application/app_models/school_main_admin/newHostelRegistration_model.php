...
class newHostelRegistration_Model extends Zf_Model {
    ...
    */
    public function registerNewHostel(){
        
        //In this section we chain class data, posted from the form.
        $this->zf_formController->zf_postFormData('hostelName')
                                ->zf_validateFormData('zf_maximumLength', 45, 'Hostel name')
                                ->zf_validateFormData('zf_minimumLength', 2, 'Hostel name')
                                ->zf_validateFormData('zf_fieldNotEmpty', 'Hostel name')

                                ->zf_postFormData('hostelAlias')
                                ->zf_validateFormData('zf_maximumLength', 45, 'Hostel alias')
                                ->zf_validateFormData('zf_minimumLength', 2, 'Hostel alias')
                                ->zf_validateFormData('zf_fieldNotEmpty', 'Hostel alias')
                
                                ->zf_postFormData('hostelGender')
                                ->zf_validateFormData('zf_maximumLength', 45, 'Hostel gender')
                                ->zf_validateFormData('zf_minimumLength', 2, 'Hostel gender')
                                ->zf_validateFormData('zf_fieldNotEmpty', 'Hostel gender')
                
                                ->zf_postFormData('hostelCapacity')
                                ->zf_validateFormData('zf_maximumLength', 45, 'Hostel capacity')
        ...
        //echo "<pre>All Hostel Data<br>"; print_r($this->_errorResult); echo "</pre>"; echo "<pre>"; print_r($this->_validResult); echo "</pre>"; exit();
