...
class department_select_Model extends Zf_Model {
    ...
    public function zvs_buildDepartmentSelectCode($identificationCode) {
        
        $systemSchoolCode = Zf_Core_Functions::Zf_DecodeIdentificationCode($identificationCode)[2];
        
        $zvs_sqlValue["systemSchoolCode"] = Zf_QueryGenerator::SQLValue($systemSchoolCode);
        
        $zf_selectClasses = Zf_QueryGenerator::BuildSQLSelect('zvs_school_departments', $zvs_sqlValue);
        ...
        if(!$this->Zf_QueryGenerator->Query($zf_selectClasses)){
            ...
            if($resultCount > 0){
                ...
                while(!$this->Zf_QueryGenerator->EndOfSeek()){
                    ...
                    echo "<option value='".$fetchRow->schoolDepartmentCode."' >".$fetchRow->schoolDepartmentName."</option>";
