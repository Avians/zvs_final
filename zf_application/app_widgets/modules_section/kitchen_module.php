...
/** 
 * This menu is used to list all resource within the kitchen module
 */
...
$zvs_controller = KTNMOD; $zvs_action = $activeURL[1]; $zvs_parameter = Zf_SecureData::zf_decode_data($activeURL[2]);
...
<li class="<?php if ($zvs_action == "kitchen_module" || $zvs_action == "new_user" || $zvs_action == "admin_directory" || $zvs_action == "admin_reports") { echo "active";} ?>">
    <a href="javascript:;">
        <i class="fa fa-users"></i>
        <span class="title"> ZVS Admin Users </span>
        <?php if ($zvs_action == "kitchen_module" || $zvs_action == "new_user" || $zvs_action == "admin_directory" || $zvs_action == "admin_reports") {?><span class="selected"></span><?php } ?>
        <span class="arrow <?php if ($zvs_action == "kitchen_module" || $zvs_action == "new_user" || $zvs_action == "admin_directory" || $zvs_action == "admin_reports") { echo "open";} ?>"></span>
    </a>
    <ul class="sub-menu">
