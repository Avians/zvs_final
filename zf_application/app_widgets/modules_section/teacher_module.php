...
/** 
 * This menu is used to list all resource within the teacher module
 */
...
$zvs_controller = TCHMOD; $zvs_action = $activeURL[1]; $zvs_parameter = Zf_SecureData::zf_decode_data($activeURL[2]);
