...
<li class="<?php if ($zvs_action == "create_fees" || $zvs_action == "allocate_finances" || $zvs_action == "collect_fees"  || $zvs_action == "finance_status" || $zvs_action == "fee_structure" || $zvs_action == "fee_defaulters" || $zvs_action == "fee_refunds") { echo "active";} ?>">
    <a href="javascript:;">
        <i class="fa fa-users"></i>
        <span class="title"> Finance Module </span>
        <?php if ($zvs_action == "create_fees" || $zvs_action == "allocate_finances" || $zvs_action == "collect_fees"  || $zvs_action == "finance_status" || $zvs_action == "fee_structure" || $zvs_action == "fee_defaulters" || $zvs_action == "fee_refunds") {?><span class="selected"></span><?php } ?>
