<?php
    ...
    $assign_subjects_to_class = "assign_subjects_to_class";
    
?>

<form action="<?php Zf_GenerateLinks::basic_internal_link("subject_module", "processSubjectAssignment", $assign_subjects_to_class); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="assign_subjects_to_class_form">
    <div class="form-wizard" id="assignSubjectsToClass">
        <div class="form-body">
            <ul class="nav nav-pills nav-justified steps">
                <li>
                    <a href="#assignSubjectsToClassInfo" data-toggle="tab" class="step active">
                        <span class="number">
                            1
                        </span>
                ...
                <li>
                    <a href="#confirmAssignSubjectsToClassInfo" data-toggle="tab" class="step">
                        <span class="number">
                            2
                        </span>
                        <span class="desc progress-form-title">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="assignSubjectsToClassInfo">
                ...
                <div class="tab-pane" id="confirmAssignSubjectsToClassInfo">
