                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input type="text" name="budgetedAmount"  class="form-control currencyField" placeholder="2500, 30000, 45000" value="<?php echo $zf_formHandler->zf_getFormValue("budgetedAmount"); ?>">
                                    <span class="help-block server-side-error" >
                                        <?php echo $zf_formHandler->zf_getFormError("budgetedAmount"); ?>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-5">Budgeted Amount</label>
                                <div class="col-md-7">
                                    <p class="form-control-static confirm-form-result"  data-display="budgetedAmount"></p>
                                </div>
                            </div>
                        </div>
                        <!--/span-->
