<?php if(Zf_SessionHandler::zf_getSessionVariable('class_setup') == 'class_form_error'){ ?>
...
<?php
}else if(Zf_SessionHandler::zf_getSessionVariable('class_setup') == 'existent_class_error'){ 
?>
    <div class="alert alert-danger display-none error-fadeout">
        <button class="close" data-dismiss="alert"></button>
...
<?php  
}else if(Zf_SessionHandler::zf_getSessionVariable('class_setup') == 'class_setup_success'){
?>
...
if(Zf_SessionHandler::zf_getSessionVariable('class_setup') == 'stream_form_error'){ ?>
    <div class="alert alert-danger display-none error-fadeout">
        <button class="close" data-dismiss="alert"></button>
...
<?php
}else if(Zf_SessionHandler::zf_getSessionVariable('class_setup') == 'existent_stream_error'){ 
?>
    <div class="alert alert-danger display-none error-fadeout">
        <button class="close" data-dismiss="alert"></button>
...
<?php  
}else if(Zf_SessionHandler::zf_getSessionVariable('class_setup') == 'stream_setup_success'){
?>
    <div class="alert alert-success display-none success-fadeout">
        <button class="close" data-dismiss="alert"></button>
...
Zf_SessionHandler::zf_unsetSessionVariable("class_setup");
?>
