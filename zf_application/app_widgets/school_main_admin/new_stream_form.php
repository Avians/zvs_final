...
<form action="<?php Zf_GenerateLinks::basic_internal_link("school_main_admin", "newClassRegistration", $new_stream); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="new_stream_form">
                ...
                <li>
                    <a href="#newStreamInfo" data-toggle="tab" class="step active">
                        ...
                        <span class="desc progress-form-title">
                            <i class="fa fa-check"></i> New Stream Setup
                        </span>
                    </a>
                </li>
                <li>
                    <a href="#confirmNewStreamInfo" data-toggle="tab" class="step">
                        ...
                        <span class="desc progress-form-title">
                            <i class="fa fa-check"></i> Confirm Stream Details
                        </span>
                    </a>
                </li>
            </ul>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="streamCapacity" class="form-control" placeholder="50, 65, 100, ..." value="<?php echo $zf_formHandler->zf_getFormValue("streamCapacity"); ?>">
                                    <span class="help-block server-side-error" >
                                        <?php echo $zf_formHandler->zf_getFormError("streamCapacity"); ?>
                                    </span>
                                </div>
                            </div>
                        </div>
