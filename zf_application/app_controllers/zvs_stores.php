...
/**
 * -----------------------------------------------------------------------------
 * THIS IS THE STORES CONTROLLER, ESSENTIAL FOR ROUTING AND EXECUTING ALL ACTIONS
 * THAT RELATE TO STORES MODELS AND VIEWS.
 * -----------------------------------------------------------------------------
 *
...
class Zvs_storesController extends Zf_Controller {
