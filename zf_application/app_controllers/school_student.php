...
/**
 * -----------------------------------------------------------------------------
 * THIS IS THE SCHOOL_STUDENT CONTROLLER, ESSENTIAL FOR ROUTING AND EXECUTING 
 * ALL ACTIONS THAT RELATE TO SCHOOL STUDENT MODELS AND VIEWS.
 * -----------------------------------------------------------------------------
 *
...
class School_studentController extends Zf_Controller {
