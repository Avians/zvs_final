...
/**
 * -----------------------------------------------------------------------------
 * THIS IS THE BOG CONTROLLER, ESSENTIAL FOR ROUTING AND EXECUTING ALL ACTIONS
 * THAT RELATE TO BOG MODELS AND VIEWS.
 * -----------------------------------------------------------------------------
 *
...
class Zvs_bogController extends Zf_Controller {
