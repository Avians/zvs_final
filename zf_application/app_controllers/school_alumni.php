...
/**
 * -----------------------------------------------------------------------------
 * THIS IS THE SCHOOL_ALUMNI CONTROLLER, ESSENTIAL FOR ROUTING AND EXECUTING ALL
 * ACTIONS THAT RELATE TO SCHOOL ALUMNI MODELS AND VIEWS.
 * -----------------------------------------------------------------------------
 *
...
class School_alumniController extends Zf_Controller {
