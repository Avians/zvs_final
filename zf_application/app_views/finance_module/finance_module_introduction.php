    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">Finance Module</h3>
                ...
                <div class="row margin-top-20">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="border-right: 1px solid #efefef; min-height: 300px !important; height: auto !important; text-align: center !important">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style=" margin-top: 20px !important;">
                            <img src="<?php echo ZF_ROOT_PATH.ZF_DATASTORE."zvs_module_images".DS."finance.png"; ?>" width=" 75% " height=" 75%" alt="Finance Module" >
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 portlet-titles margin-top-20" style=" font-size: 12px !important;">
                            <p>This module contains all resources that the school administrator has allowed for your use to access and/or manage all finance related information.<br></p>
                            <p><br>With over seven resources, you will only be able to use resources whose access you have have been assigned to your school role. If all resource are taken away from the role, the entire module will not be available for your use.</p>
                        </div>
                    </div>
                </div>
            </div>
