        ...
        <div class="page-content">
            ...
            <?php 
                ...
                foreach ($schoolInformation as $value) {
                    ...
                    $schoolName = $value['schoolName']; $schoolRegDate = date(" jS M, Y", strtotime($value['dateCreated'])); $dateOfEstablishment = date(" jS M, Y", strtotime($value['dateOfEstablishment'])); $schoolType =  $value['schoolType']; $schoolStatus = $value['schoolStatus'];
                    ...
                    <div class="portlet box zvs-content-blocks">
                        ...
                        <div class="portlet-body-short" style="border: 0px solid #000 !important;">
                            ...
                            if($identificationCode == $createdBy){ ?>
                                This school was registered to Zilas Virtual Schools<sup style='font-size: 8px !important; font-style: normal;'>TM</sup> by me.    
