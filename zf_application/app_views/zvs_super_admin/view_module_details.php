<?php
    ...
    $actualModuleDetails = $zf_controller->zf_targetModel->zvs_fetchCategoriesDetails($urlParameter);
    
    foreach ($actualModuleDetails as $moduleDetails) {
        
        $moduleName = $moduleDetails['categoryName']; $modulePrefix = $moduleDetails['categoryPrefix']; 
        $moduleStatus = $moduleDetails['categoryStatus']; $dateCreated = $moduleDetails['dateCreated'];

        $currentStatus = ($moduleStatus == 1 ? 'Active - <i class="fa fa-check-circle-o" style="color:#3c763d !important;"></i>':'Inactive - <i class="fa fa-times-circle-o" style="color:#a94442 !important;"></i>');
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">Module Details</h3>
                        ...
                        <div>
                            <div class="row margin-top-10">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-condensed table-responsive table-hover">
                                                            <tbody>
                                                                <tr>
                                                                    <td style="padding-top: 15px !important; padding-bottom: 15px !important; color: #21B4E2 !important;text-align: right !important; width: 100px;">Module Prefix:</td>
                                                                    <td style="padding-top: 15px !important; padding-bottom: 15px !important;"><?= $modulePrefix; ?></td></tr>
                                                                <tr>
                                                                    <td style="padding-top: 15px !important; padding-bottom: 15px !important; color: #21B4E2 !important;text-align: right !important;">Module Name:</td>
                                                                    <td style="padding-top: 15px !important; padding-bottom: 15px !important;"><?= $moduleName; ?></td></tr>
                                                                <tr>
                                                                    <td style="padding-top: 15px !important; padding-bottom: 15px !important; color: #21B4E2 !important;text-align: right !important;">Module Status:</td>
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                                    <div class="portlet box zvs-content-blocks">
                                        <div class="zvs-content-titles">
                                            <h3><?php echo $moduleStatus == 1 ? 'Deactivate':'Activate'; ?> <?=$moduleName;?> Module</h3>
                                        </div>
                                        <div class="portlet-body">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <?php Zf_ApplicationWidgets::zf_load_widget("zvs_super_admin", "edit_module_form.php", $urlParameter); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
