<?php
    ...
    foreach ($actualModuleDetails as $moduleDetails) {
        ...
        $currentStatus = ($moduleStatus == 1 ? 'Active - <i class="fa fa-check-circle" style="color:#3c763d !important;"></i>':'Inactive - <i class="fa fa-times-circle" style="color:#a94442 !important;"></i>');
