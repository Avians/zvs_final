        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">Super Administrator's Profile</h3>
                ...
                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                    <div class="portlet box zvs-content-blocks">
                        <div class="zvs-content-titles">
                            <h3>Super Administrator Profile</h3>
                        </div>
                        ...
                        <div class="portlet-body" style="text-align: justify;">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <p><?= $designation." ".$userName; ?> is a Platform Super Administrator at Zilas Virtual Schools<sup style='font-size: 8px !important; font-style: normal;'>TM</sup>. <?=$referrer;?> platform ID Number is <span style='color: #32B9E4; '><?=$idNumber;?></span> and has been registered to the platform since <?=$dateCreated;?>.</p>
                                    <p>As a Platform Super Administrator, <?=$referrer2;?> registers new platform administrators and has the ability to execute their respective duties. In addition, <?=$referrer2;?> has the power to suspend platform administrators who faults platform regulations as well as view their performance indicators for monitoring and evaluation purposes. </p>
                                </div>
                            </div>
                            <div class="row">
