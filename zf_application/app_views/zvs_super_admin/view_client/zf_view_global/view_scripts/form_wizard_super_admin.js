var SuperAdminFormWizard = function () {
    ...
    return {
        ...
        init: function () {
            ...
            var displayConfirm = function() {
                $('#confirmSuperAdminInfo .form-control-static', form).each(function(){
            ...
            // default form wizard
            $('#super_admin_form').bootstrapWizard({
            ...
            $('#super_admin_form').find('.button-previous').hide();
            $('#super_admin_form .button-submit').click(function () {
