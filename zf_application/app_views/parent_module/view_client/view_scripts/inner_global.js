    ...
    var student_profile = function ($absolute_path, $separator){
        ...
        $('.studentsListDetails').change(function(){
            ...
            $('#studentProfileContainer').fadeIn(1000, function(){
                ...
                var processStudentDetails = $absolute_path + "parent_module" + $separator + "GuardianProfile" + $separator + "process_student_profile";
            ...
            $('#guardianProfileContainer').fadeIn(1000, function(){
                ...
                var processGuardianDetails = $absolute_path + "parent_module" + $separator + "GuardianProfile" + $separator + "process_student_guardian";
                var studentIdentificationCode = identificationCode;
