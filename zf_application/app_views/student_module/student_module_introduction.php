                ...
                <div class="row margin-top-20">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 portlet-titles margin-top-20" style=" font-size: 12px !important;">
                            <p>This module contains all resources that the school administrator has allowed for your use to access and/or manage all student related information.<br></p>
