var EditModuleFormWizard = function () {
    ...
    return {
        ...
        init: function () {
            ...
            var handleTitle = function(tab, navigation, index) {
                ...
                var current = index + 1;
                // set wizard title
                $('.step-title', $('#edit_module_form')).text('Step ' + (index + 1) + ' of ' + total);
                // set done steps
                jQuery('li', $('#edit_module_form')).removeClass("done");
                ...
                if (current == 1) {
                    $('#editModuleForm').find('.button-previous').hide();
                } else {
                    $('#editModuleForm').find('.button-previous').show();
                }

                if (current >= total) {
                    $('#editModuleForm').find('.button-next').hide();
                    $('#editModuleForm').find('.button-submit').show();
                    displayConfirm();
                } else {
                    $('#editModuleForm').find('.button-next').show();
                    $('#editModuleForm').find('.button-submit').hide();
                }
            ...
            $('#submit_form').bootstrapWizard({
                ...
                onTabShow: function (tab, navigation, index) {
                    ...
                    $('#edit_module_form').find('.progress-bar').css({
                        width: $percent + '%'
                    });
                }
            });
