...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <?php
            ...
            $zf_widgetFolder = "indicators"; $zf_widgetFile = "grade_setup_indicator.php";
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 zozo_tab_wrapper">
                <div id="tabbed-nav">
                    <ul class="z-tabs-titles">
                        <li><a>Marksheet overview</a></li>
                        <li><a><i class="fa fa-plus-square"></i> Add new grades</a></li>
                        <li><a><i class="fa fa-edit"></i> Edit existing grades</a></li>
                        <li><a><i class="fa fa-link"></i> Assign grades to subjects</a></li>
                        <li><a><i class="fa fa-edit"></i> Edit subjects grades</a></li>
                    </ul>
