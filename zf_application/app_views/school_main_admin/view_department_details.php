<?php
    ...
    $schoolDepartmentCode = Zf_SecureData::zf_decode_url($activeURL[2]);
    ...
    $actualDepartmentDetails = $zf_controller->zf_targetModel->zvs_fetchDepartmentOuterDetails($schoolDepartmentCode);
    
    foreach ($actualDepartmentDetails as $departmentDetails) {
        
        $departmentName = $departmentDetails[schoolDepartmentName];
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 zozo_tab_wrapper">
            <div id="tabbed-nav">
                <ul class="z-tabs-titles">
                    <li><a><?=$departmentName;?> Overview</a></li>
                    <li><a><i class="fa fa-edit"></i>Edit <?=$departmentName;?></a></li>
                </ul>
