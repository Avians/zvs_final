<?php
    ...
    $schoolClassCode = $urlParameterArray[1].ZVSS_CONNECT.$urlParameterArray[2];
    ...
    $actualClassDetails = $zf_controller->zf_targetModel->zvs_fetchClassOuterDetails($schoolClassCode);
    $classCapacity = $zf_controller->zf_targetModel->zvs_classCapacityCount($schoolClassCode);
    $classOccupancy = $zf_controller->zf_targetModel->zvs_classOccupancyCount($schoolClassCode);
    $classStreams = $zf_controller->zf_targetModel->zvs_classStreamsCount($schoolClassCode);
    $classAvailability = $classCapacity-$classOccupancy;
    
    foreach ($actualClassDetails as $classDetails) {
        
        $className = $classDetails['schoolClassName'];
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 zozo_tab_wrapper">
                <div id="tabbed-nav">
                    <ul class="z-tabs-titles">
                        <li><a><?=$className;?> Overview</a></li>
                        <li><a><i class="fa fa-edit"></i>Edit <?=$className;?></a></li>
                    </ul>
