...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <?php
            ...
            $zf_widgetFolder = "indicators"; $zf_widgetFile = "exam_setup_indicator.php";
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 zozo_tab_wrapper">
                <div id="tabbed-nav">
                    <ul class="z-tabs-titles">
                        <li><a>Examinations overview</a></li>
                        <li><a><i class="fa fa-plus-square"></i> Add an examination</a></li>
                        <li><a><i class="fa fa-edit"></i> Edit examinations</a></li>
                    </ul>
                                    ...
                                    <div class="portlet box zvs-content-blocks" style="min-height: 340px !important;">
                                        <div class="portlet-body form" >
                                            <?php
                                                ...
                                                Zf_ApplicationWidgets::zf_load_widget("school_main_admin", "new_exam_form.php");
                                            ?>
                                        </div>
                                    </div>          
                                </div>
