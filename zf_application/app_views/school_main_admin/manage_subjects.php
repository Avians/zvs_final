    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">Manage Subjetcs</h3>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 zozo_tab_wrapper">
                <div id="tabbed-nav">
                    <ul class="z-tabs-titles">
                        <li><a>Subjects overview</a></li>
                        <li><a><i class="fa fa-plus-square"></i> Add a new subject</a></li>
                        <li><a><i class="fa fa-edit"></i> Edit selected subject</a></li>
                    </ul>
                                    ...
                                    <div class="portlet box zvs-content-blocks" style="min-height: 340px !important;">
                                        <div class="portlet-body form" >
                                            <?php
                                                ...
                                                Zf_ApplicationWidgets::zf_load_widget("school_main_admin", "new_subject_form.php");
                                            ?>
                                        </div>
                                    </div>          
                                </div>
