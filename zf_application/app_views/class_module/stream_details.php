<?php
    ...
    //Here we load class module model for processing stream details information
    $zf_controller->Zf_loadModel("class_module", "stream_details");
                    ...
                    <div id="tabbed-nav">
                        ...
                        <div class="z-content-inner" style="margin-bottom: 10px !important;">
                            <div>
                                ...
                                <div class="row margin-top-10" >
                                    <?=$zf_controller->zf_targetModel->zvs_getStreamDetails($zf_actionData);?>   
                                </div>
                            </div>
                        </div>
                    </div>
