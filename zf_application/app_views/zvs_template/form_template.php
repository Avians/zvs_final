    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">New Form Template</h3>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 zozo_tab_wrapper">
                <div id="tabbed-nav">
                    <ul class="z-tabs-titles">
                        <li><a><i class="fa fa-plus-square"></i> New Form Here</a></li>
                    </ul>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: -15px !important;">
                                    <div class="portlet box zvs-content-blocks" style="min-height: 350px !important;">
                                        <div class="portlet-body form" >
                                            <?php
                                                //This is the template form for zvs
                                                Zf_ApplicationWidgets::zf_load_widget("zvs_template", "new_template_form.php");
                                            ?>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var $separator = "<?= DS; ?>";
        var $current_view = "form_template";

        //Form_Template.init($current_view, $absolute_path, $separator );
