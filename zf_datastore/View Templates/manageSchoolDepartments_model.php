...
class manageSchoolDepartments_Model extends Zf_Model {
    ...
    */
    ...
    public function fetchDepartmentsDetails($identificationCode){
         ...
         if($zvs_departmentDetails == 0){
             ...
             foreach($zvs_departmentDetails as $departmentValues){
                 ...
                 //Fetch and return all department heads
                 $zvs_departmentHeads = $this->zvs_fetchDepartmentHeads($schoolDepartmentCode);
                 
                 //Fetch and return all sub-departments details.
                 $zvs_subDepartmentDetails = $this->zvs_fetchSubDepartmentDetails($schoolDepartmentCode);
            ...
            $zvs_departmentGridView .='<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <div class="portlet box zvs-content-blocks" style="min-height: 340px !important;">
                                                ...
                                                <div class="portlet-body">
                                                      ...
                                                      if($zvs_departmentHeads == 0){
                                                          
                                                          $zvs_departmentGridView .='<div class="row">
                                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                            <div class="zvs-content-warnings" style="text-align: center !important; padding-top: 20px !important; padding-bottom: 20px !important;">
                                                                                                <i class="fa fa-warning" style="color: #B94A48 !important;font-size: 18px !important;"></i>
                                                                                                <span class="content-view-errors" >
                                                                                                    &nbsp;Heads of '.$zvs_departmentName.' department not registered!.
                                                                                                </span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>';
                                                          ...
                                                          //foreach ($zvs_departmentHeads as $departmentHeadsValues) {
                                                                                              ...
                                                                                              <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 margin-top-10">
                                                                                                  <div class="table-responsive">
                                                                                                      <table class="table table-striped table-condensed table-responsive table-hover">
                                                                                                          <tbody>
                                                                                                              <tr><td><i class="fa fa-user" style="color: #d5d5d5 !important;"></i></td><td><?= $designation." ".$userName; ?></td></tr>
                                                                                                              <tr><td><i class="fa fa-phone" style="color: #d5d5d5 !important;"></i></td><td><?= $mobileNumber; ?></td></tr>
                                                                                                              <tr><td><i class="fa fa-envelope" style="color: #d5d5d5 !important;"></i></td><td><?= $address; ?></td></tr>
                                                                                                          </tbody>
                                                                                                      </table>
                                                                                                  </div>
                                                                                              </div>
                                                             ...
                                                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                 <div class="table-responsive">
                                                                     <table class="table table-striped table-hover">
                                                                         ...
                                                                         <tbody>
                                                                             <tr><td>English</td><td>Mathew Juma</td><td>0727074108</td><td><a href="#" title="View sub-department"><i class="fa fa-list"></i></a></td></tr>
                                                                         </tbody>
                                                                     </table>
                                                                 </div>
                                                             </div>
    ...
    /**
     * This method checks and returns department heads for a given school department.
     */
    private function zvs_fetchDepartmentHeads($schoolDepartmentCode){
    ...
    /**
     * This method checks and returns sub-department details for a given school department.
     */
